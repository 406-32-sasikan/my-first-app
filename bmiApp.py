...
weight =  st.number_input("กรอกน้ำหนักของคุร (กิโลกรัม):")
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):")


#ส่วนที่ 3 สร้างปุ่มกดคำนวณ
if st.button("คำนวณค่า BMI🏃"):
   # แปลงส่วนสูงจาก Cm เป็น เมตรแล้วคำนวณ BMI
   height_m - height_cm / 100
   bmi = weight / (height_m ** 2)

   st.write("---")
   st.header9f"ค่า BMI ของคุณคือ : **{bmi:.2f}**)
...
#ส่วนที่ 4 แปลงผลค่า BMI ตามเกณฑ์
 if bmi < 18.5 :
  ...
  st.success("❤️ คุณมีน้ำหนักอยู๋ในเกณฑ์ปกติ (สุขภาพดี)")
   ...
   st.error("คุรอยู๋ในเกณฑือ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย")
